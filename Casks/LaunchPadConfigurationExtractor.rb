cask "launchpadconfigurationextractor" do
  ...
  url "https://github.com/krusoft-eu/homebrew-utils/releases/download/#{version}/LaunchPadConfigurationExtractor.dmg"
  name "LaunchPadConfigurationExtractor"
  ...
  app "LaunchPadConfigurationExtractor.app"
